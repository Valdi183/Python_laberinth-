...
de la instancia, la segunda crea el muero (con las X donde hay muro)y los puntos de inicio (E) y de fin (S). 
...
class Laberinto:
    ...
    de Salida(S) y Entrada(E). Cabe recalcar, que en python antes de ejecutar el código, se "lee"primero para registrar las funciones 
